...
interface LoveInitializer {
    ...
    class Base(private val coreDao: CoreDao,private val chaptersDao: ChaptersDao): LoveInitializer {
        override fun init() {
            ...
            list.add(
                InfoModelDb(
                    "Что включает в себя любовь",
                    "love/cto_vklyucayet_lubov",
                    type = Type.LOVE
                )
            )
            ...
            list.add(
                InfoModelDb(
                    "Вы не можете влюбиться,потому-что...",
                    "love/pricini_ne_lyubvi",
                    type = Type.LOVE
                )
            )
            list.add(
                InfoModelDb(
                    "Как полюбить человека, который тебя любит",
                    "love/kak_polubit",
                    type = Type.LOVE
                )
            )
            ...
            list.add(
                InfoModelDb(
                    "Невозможно добывать то, чего нет",
                    "love/nevozmojno_dobavit",
                    type = Type.LOVE
                )
            )
            ...
            list.add(
                InfoModelDb(
                    "Любовь воздействует на организм как наркотик",
                    "love/lubov_narkotik",
                    type = Type.LOVE
                )
            )
            list.add(
                InfoModelDb(
                    "Любовь и шоколад не существуют по отдельности",
                    "love/lubov_shakalad_ne_odin",
                    type = Type.LOVE
                )
            )
            list.add(
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                chaptersDao.insertChapter(ChapterModelDb("ЛЮБОВЬ", list.size, R.drawable.ic_talk, 0f, fragmentName = ChapterModelDb.FragmentName.LOVE, colorLight = "#B32438", colorNight = "#24303E"))
                coreDao.updateChapterSize("ЛЮБОВЬ",coreDao.fetchLoveCount(Type.LOVE).size)
            }
        }
    }
}